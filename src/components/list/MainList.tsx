...
const MainList:FC = () => {
 ...
 const [isNearEnd,setIsNearEnd]=useState(false) 
  ...
  const backToTopStyle=useAnimatedStyle(()=>{ 
    ...
    const opacity=withTiming(isScrollingUp && (isRestaurantVisiable || isNearEnd) ? 1:0,{duration:300})
    const translateY=withTiming(isScrollingUp && (isRestaurantVisiable || isNearEnd) ? 0:10,{duration:300})
